...
export class ProcessorFacebook {
    ...
    ): Promise<FacebookDataAggregator | undefined> {
        try {
    ...
    static async aggregatorBuilder(
        ...
        if (
            ...
            (regex = new RegExp(FileCodeFacebook.LANGUAGE)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.ADS_INTERACTED_WITH)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.ADS_USING_YOUR_ACTIVITY)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.ADS_INTERESTS)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.INFO_SUBMITTED_ADS)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.SEARCH_HISTORY)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.COMMENTS)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.PAGES_LIKED)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.PAGES_FOLLOWED)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.PAGES_RECOMMENDED)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.PAGES_UNFOLLOWED)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.YOUR_POSTS)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.YOUR_TOPICS)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.RECENTLY_VIEWED)) &&
            regex.test(pathName)
        ) {
            ...
            if (result) {
                if (result.videoWatched) {
                    ...
                    model.engagement.videoWatchedTI =
            ...
            (regex = new RegExp(FileCodeFacebook.RECENTLY_VISITED)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.REACTIONS)) &&
            regex.test(pathName)
        ) {
            result = (await ServiceFacebook.parseReactions(
                data,
            )) as ReactionsFB;
            if (result) {
            ...
            (regex = new RegExp(FileCodeFacebook.FRIENDS)) &&
            regex.test(pathName)
        ) {
            ...
            (regex = new RegExp(FileCodeFacebook.FRIENDS_WHO_YOU_FOLLOW)) &&
            regex.test(pathName)
        ) {
