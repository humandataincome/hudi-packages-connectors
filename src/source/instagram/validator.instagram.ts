...
import {
    ValidatorDatasource,
    ValidatorDatasourceOption,
} from '../../validator/validator.datasource';
...
export class ValidatorInstagram extends ValidatorDatasource {
    ...
    protected DEFAULT_FILE_CODES: FileCodeInstagram[] = [
        ...
        FileCodeInstagram.v2_ACCOUNT_VIEWED,
        FileCodeInstagram.v2_ADS_CLICKED,
        FileCodeInstagram.ADS_USING_YOUR_INFO,
        FileCodeInstagram.v2_ADS_VIEWED,
        ...
        FileCodeInstagram.v2_VIDEO_VIEWED,
    ...
    public async getLanguage(
        ...
        if (new RegExp(FileCodeInstagram.PERSONAL_INFO).test(pathName)) {
            ...
            if (
                document.match(
                    /(Nome utente)|(Indirizzo e-mail)|(Data di nascita)/,
                )
            ) {
                return LanguageCode.ITALIAN;
            } else if (
                document.match(
                    /(Email address)|(Phone number confirmed)|(Username)/,
                )
            ) {
                return LanguageCode.ENGLISH;
            } else if (
                document.match(
                    /(Nombre de usuario)|(Cuenta privada)|(Correo electr\\u00c3\\u00b3nico)/,
                )
            ) {
                return LanguageCode.SPANISH;
            } else if (
                document.match(
                    /(\\u00e0\\u00a4\\u0088\\u00e0\\u00a4\\u00ae\\u00e0\\u00a5\\u0087\\u00e0\\u00a4\\u00b2)|(\\u00e0\\u00a4\\u00aa\\u00e0\\u00a5\\u008d\\u00e0\\u00a4\\u00b0\\u00e0\\u00a4\\u00be\\u00e0\\u00a4\\u0087\\u00e0\\u00a4\\u00b5\\u00e0\\u00a5\\u0087\\u00e0\\u00a4\\u009f \\u00e0\\u00a4\\u0085\\u00e0\\u00a4\\u0095\\u00e0\\u00a4\\u00be\\u00e0\\u00a4\\u0089\\u00e0\\u00a4\\u0082\\u00e0\\u00a4\\u009f)|(\\u00e0\\u00a4\\u00af\\u00e0\\u00a5\\u0082\\u00e0\\u00a4\\u009c\\u00e0\\u00a4\\u00bc\\u00e0\\u00a4\\u00b0\\u00e0\\u00a4\\u00a8\\u00e0\\u00a5\\u0087\\u00e0\\u00a4\\u00ae)/,
                )
            ) {
                return LanguageCode.HINDI;
            } else if (
                document.match(
                    /(Adresse e-mail)|(Num\\u00c3\\u00a9ro de t\\u00c3\\u00a9l\\u00c3\\u00a9phone)|(Nom d\\u00e2\\u0080\\u0099utilisateur)/,
                )
            ) {
                return LanguageCode.FRENCH;
            } else if (
                document.match(
                    /(Benutzername)|(E-Mail-Adresse)|(Telefonnummer)/,
                )
            ) {
                ...
                this.logger.log(
                    'error',
                    `${ValidationErrorEnum.LANGUAGE_ERROR}: the zip file has not a recognizable language to be corrected parsed`,
                    'getLanguage',
                );
                if (
                    options &&
    ...
    public getFileCode(pathName: string): string | undefined {
        ...
        return Object.values(FileCodeInstagram).find((code: string) =>
