    ...
    public static objectIsEmpty(obj: any): boolean {
        if (obj && Object.keys(obj).length > 0) {
            const reducer = (previousValue: boolean, currentValue: string) => {
                ...
                return (
                    subObject === '' || //if the element value is ''
                    subObject === undefined || //if the element value is undefined
                    subObject === null || //if the element value is null
                    (Array.isArray(subObject) &&
                        (subObject.length === 0
                            ? true
                            : this.objectIsEmpty(subObject))) || //if the element value is an Array, True if is empty, recursive call otherwise
                    (Object.getPrototypeOf(subObject) === Object.prototype &&
                        this.objectIsEmpty(subObject) && //if the element value is an Object, recursive call
                        previousValue)
                );
            };
