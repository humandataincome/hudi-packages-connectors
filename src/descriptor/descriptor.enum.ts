...
export enum FileCode {
    ...
    INSTAGRAM_ADS_INTERESTS = 'information_about_you/ads_interests.json',
    ...
    INSTAGRAM_ELIGIBILITY = 'monetization/eligibility.json',
    ...
    FACEBOOK_PAGES_RECOMMENDED = 'pages/pages_you’ve_recommended.json',
