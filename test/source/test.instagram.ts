...
async function testService() {
    try {
        ...
        console.log(await ServiceInstagram.parseYourTopics(Buffer.from(JSON.stringify(require(`../../src/mock/datasource files/instagram_json/your_topics/your_topics.json`)))));
